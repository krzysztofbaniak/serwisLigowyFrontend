'use client'
import CreateRecruitmentForm from "@/fragments/recruitments/createRecruitmentForm";
import {useContext, useEffect, useState} from "react";
import {UserContext} from "@/app/providers";
import {useCookies} from "react-cookie";

export default function CreateRecruitmentPageBody() {
    ...
    return (
        <div>
            <CreateRecruitmentForm profile={profile} />
        </div>
    )
}
